...
public class CreateSanPhamCommandHandler {
    private final GoiTapRespository repository;

    public DataResponse handle(CreateSanPhamCommand request) {
        GoiTap goiTap = new GoiTap();
        goiTap.setId(request.getId());
        ...
        goiTap.setSoNgay(request.getSoNgay());
